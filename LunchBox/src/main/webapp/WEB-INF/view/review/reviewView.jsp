...
<script src="../assets/js/color-modes.js"></script>
    ...
    <link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
  	...
  	<link href="https://fonts.googleapis.com/css?family=Playfair&#43;Display:700,900&amp;display=swap" rel="stylesheet">
  	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/viewReviewArticle.css?after"/>
	<title>게시글 읽기</title>
</head>
...
<article class = "reviewViewDetail">
<div class = inner>
<h3 class = "reviewTitle2"><c:out value='${article.articleTitle}'></c:out></h3>
<hr  class="hr">
<p class="reviewContent">
<u:pre value='${article.articleContent}'/>
</p>
</div>
</article> 
...
<ul>
		...
		<li class="btn-list"><a href="list?pageNo=${pageNo}">목록</a></li>
		<c:if test="${memberSession.memTypeNo==99}">
		<li class="btn-list"><a href="/review/modify?articleNo=${article.articleNo}">수정</a></li>
		<li class="btn-list"><a href="/review/delete?articleNo=${article.articleNo}">삭제</a></li>
		</c:if>
</ul>
</div>
