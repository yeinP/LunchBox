...
<script src="../assets/js/color-modes.js"></script>
    ...
    <link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
  	...
  	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/reviewModify.css?after"/>
	<title>후기 글 수정</title>
</head>
...
<tbody>
	<tr>
	<th>글 번호</th>
	<td><input type="hidden" name="articleNo" value="${article.articleNo}">${article.articleNo}</td>
	</tr>
	<tr>
		<th>제목</th>
		<td><input type="text"  class="articleTitle" name="articleTitle" value="${article.articleTitle}"></td>
		<c:if test="${errors.articleTitle}">제목을 입력하세요.</c:if>
	</tr>
	<tr>
	<th>내용</th>
	<td><textarea name="articleContent"  class="articleContent"  rows="8" cols="30">${article.articleContent}</textarea></td>
	</tr>
</tbody>
</table>
<div class="submit">
