...
<header class="info">
<h6>- 매일 메뉴는 변경됩니다.</h6>
<h6>- 뉴 및 원재료는 계절별 식자재 또는 수급 사정에 따라 변경될 수 있습니다.</h6>
</header>
</div>
<div class="menuList">
	...
	<div class="list">
		<div class="today">
			<span class="todayMenu">오늘의 메뉴</span>
		</div>
		<div class="menu">
		<div class="one">
		<div class="two">
		...
		<div class = "detial">
		<h6 class="name"> 베이직A </h6>
		<h6 class="name1"> 간단 한끼 </h6>
		</div>
		</div>
		</div>
		</div>
		...
		<h6 class="name"> 베이직B </h6>
		<h6 class="name1"> 균형 한끼 </h6>
		</div>
		</div>
		</div>
		<div class="one">
		...
		<h6 class="name"> 해피C </h6>
		<h6 class="name1"> 행복한 한끼 </h6>
		</div>
		</div>
		</div>
