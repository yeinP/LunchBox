...
<script src="../assets/js/color-modes.js"></script>
    ...
    <link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
  	...
  	<link href="https://fonts.googleapis.com/css?family=Playfair&#43;Display:700,900&amp;display=swap" rel="stylesheet">
  	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/viewNoticeArticle.css?after"/>
	<title>게시글 읽기</title>
</head>
...
<article class = "noticeViewDetail">
<div class = inner>
<h3 class = "noticeTitle2"><c:out value='${article.articleTitle}'></c:out></h3>
<hr  class="hr">
...
<ul>
		...
		<li class="btn-list"><a href="/notice/modify?articleNo=${article.articleNo}">수정</a></li>
		<li class="btn-list"><a href="/notice/delete?articleNo=${article.articleNo}">삭제</a></li>
		</c:if>
</ul>
</div>
