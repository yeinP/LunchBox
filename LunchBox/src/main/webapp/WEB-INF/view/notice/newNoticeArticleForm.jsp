...
<tbody>
	<tr>
		<th>제목</th>
		<td><input type="text"  id="articleTitle" class="articleTitle" name="articleTitle"></td>
	</tr>
	<tr>
	<th>내용</th>
	<td><textarea name="articleContent" id="articleContent" class="articleContent"  rows="8" cols="30"></textarea></td>
	</tr>
</tbody>	
...
$("#submit").on("click", function() {
    ...
    let al = alert("글 등록을 완료하였습니다. 메인으로 돌아갑니다")
