...
<script src="../assets/js/color-modes.js"></script>
    ...
    <link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
  	...
  	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/writeNotice.css?after"/>
	<title>건의 게시판 등록</title>
</head>
...
<tbody>
	...
	<!-- 입력값 수정 안되게 고치기 -->
		<th>작성자</th>
		<td><input type="hidden"  class="memId" name="memId">${authInfo.memId}</td>
	</tr>
	<tr>
		<th>제목</th>
		<td><input type="text"  class="articleTitle" name="articleTitle" id="articleTitle"></td>
	</tr>
	<tr>
	<th>내용</th>
	<td><textarea name="articleContent"  class="articleContent" id="articleContent" rows="8" cols="30"></textarea></td>
	</tr>
</tbody>	
...
<div class="submit">
<input type="submit" id="submit" value="글 등록">
</div>
</form>
</div>
</div>
