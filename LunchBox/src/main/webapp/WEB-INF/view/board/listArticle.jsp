...
<c:if test="${articlePage.hasArticles()}">
	<ul class="pager">
		...
		<a href="proposal?pageNo=${articlePage.startPage - 5}">[이전]</a>
		</c:if>
		</li>
		<li>
		<c:forEach var="pNo"  begin="${articlePage.startPage}" end="${articlePage.endPage}">
		<a class=no href="proposal?pageNo=${pNo}">${pNo}</a>
		</c:forEach>
		</li>
		<li>
		<c:if test="${articlePage.endPage < articlePage.totalPages}">
			<a href="proposal?pageNo=${articlePage.startPage + 5}">[다음]</a>
			</c:if>
			</li>
	</ul>
</c:if>
...
<div class="write">
	...
	<p class="btn-write"><a href="/board/write" >글쓰기</a></p>
